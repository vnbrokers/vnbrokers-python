...
async def main() -> None:
    ...
    print(f"Subscribing expected price with DNSE stream encoding={stream_encoding}")
    async with await broker.market_data.realtime.subscribe_expected_price(request) as subscription:
