...
async def main() -> None:
    ...
    print(f"Subscribing foreign investor data with DNSE stream encoding={stream_encoding}")
    async with await broker.market_data.realtime.subscribe_foreign(request) as subscription:
