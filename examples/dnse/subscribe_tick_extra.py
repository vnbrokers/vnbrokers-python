...
async def main() -> None:
    ...
    print(f"Subscribing tick extra with DNSE stream encoding={stream_encoding}")
    async with await broker.market_data.realtime.subscribe_tick_extra(request) as subscription:
